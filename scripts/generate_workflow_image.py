...
def create_emoji_image():
    ...
    emoji_data = [
        ("1f31f", margin),           # 🌟 star
        ("1f916", margin + 120),     # 🤖 robot (directly next to star)
        ("27a1", margin + 360),      # ➡️ arrow (120px gap from robot)
        ("1f60d", margin + 600)      # 😍 heart eyes (120px gap from arrow)
    ]
    ...
    image.save('img/workflow.png', quality=100)
